...
| **Drug** | Cadonilimab |
| **Targets** | PD-1 × CTLA-4 |
| **Indication** | Cervical/Gastric Cancer |
| **Innovation** | Optimized tetrameric variant with reduced immunogenicity |
...
| Metric | Score |
|--------|-------|
| **Patentability** | 6.75/10.0 |
| **In Silico Enablement** | 9.0/10.0 |
| **Commercial Value** | 7.5/10.0 |
| **Composite (P+S+C)** | 23.25/30.0 |
| **rNPV Estimate** | $95.0M |
